(function () {
  ...
  async function load() {
    ...
    try {
      ...
      renderStats(); renderMaterialGate(); renderHeatmap(); renderReadiness(); renderUnscheduled(); renderProcessLoad(); renderDeliveryCoverage(); renderVendorAllocations(); updateCapacityModeUi();
