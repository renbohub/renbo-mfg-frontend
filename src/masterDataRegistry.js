...
const registry = {
  ...
  parts: entity({
    ...
    fields: [
      ...
      field("planningPolicy", "Planning Policy", "select", { options: option("MTO", "MTS") }), field("assemblyPolicy", "Assembly Policy", "select", { options: option("INLINE", "SUB_ASSEMBLY") }), field("bufferStock", "Buffer Stock (%)", "number", { step: "0.01" }),
  ...
  uom: entity({
    ...
    columns: [column("uomCode", "Kode"), column("uomName", "Nama Satuan"), column("notes", "Catatan")],
    fields: [field("uomCode", "Kode Satuan", "text", { required: true }), field("uomName", "Nama Satuan", "text", { required: true }), field("notes", "Catatan", "textarea")]
  }),
  warehouses: entity({
    ...
    columns: [column("warehouseCode", "Kode"), column("warehouseName", "Nama Gudang"), column("location", "Lokasi"), column("type", "Tipe"), column("capacity", "Kapasitas"), column("isActive", "Status", { type: "active" })],
    fields: [field("warehouseCode", "Kode Gudang", "text", { required: true, generated: true }), field("warehouseName", "Nama Gudang", "text", { required: true }), field("location", "Lokasi", "textarea"), field("type", "Tipe", "select", { options: option("Main", "Sub", "Transit", "Quarantine") }), field("isActive", "Aktif", "checkbox"), field("capacity", "Kapasitas", "number", { step: "0.01" }), field("notes", "Catatan", "textarea")]
  }),
  currencies: entity({
