...
const registry = Object.freeze({
  ...
  "material-grades": source("/api/master-data/material-grades", "id", ["gradeCode", "code"], ["displayName", "gradeName", "name"], { queryMap: { q: "q", pageSize: "limit" }, metaKeys: ["thickness"], allowedParents: { substanceId: "substanceId" } }),
