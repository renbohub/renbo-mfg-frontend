const modules = [
  ...
  },
  {
    ...
    pages: [
      ...
      page("capacity-planning", "Capacity Planning", "Heatmap capacity harian untuk mengalokasikan Production Plan horizon", "/api/planning/capacity-planning", "machineCode", [col("machineCode", "Mesin"), col("machineName", "Nama"), col("lineCode", "Line"), col("status", "Status", "status")]),
