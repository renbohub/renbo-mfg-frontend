const modules = [
  ...
  },
  {
    ...
    pages: [
      ...
      page("daily-production-schedules", "Consume Daily Production", "Eksekusi Daily Production Plan yang sudah dialokasikan PPIC berdasarkan capacity", "/api/production/daily-production-schedules", "scheduleNumber", [col("scheduleNumber", "No. Daily Plan"), col("scheduleDate", "Tanggal", "date"), col("shift", "Shift"), col("monthlyProductionPlanNumber", "MPP"), col("moNumber", "MO Reference"), col("partCode", "Part"), col("plannedQty", "Plan", "number"), col("actualQty", "Actual", "number"), col("status", "Status", "status")]),
      ...
      { ...page("production-logs", "Production Logs", "Realisasi shop-floor dari Daily Production Plan PPIC", "/api/production/production-logs", "logNumber", [col("logNumber", "No. Log"), col("logDate", "Tanggal", "date"), col("shift", "Shift"), col("dailyProductionSchedule.productionPlan.planNumber", "Production Plan"), col("dailyProductionSchedule.scheduleNumber", "Daily Plan"), col("processCode", "Proses"), col("machineCode", "Mesin"), col("operatorName", "Operator"), col("qtyProduced", "Produced", "number"), col("qtyGood", "Good", "number"), col("qtyReject", "NG", "number"), col("downtime", "Downtime (min)", "number"), col("status", "Status", "status")]), createRoute: "/modules/production/production-logs/new" },
  ...
  },
  {
    ...
    pages: [
      ...
      { ...report("inventory-report", "Inventory Report", "Laporan saldo, reservation, QC, minimum stock, dan aging", "/api/reports/inventory"), reportColumns: [
