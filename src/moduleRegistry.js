const modules = [
  ...
  },
  {
    ...
    pages: [
      ...
      page("master-production-schedule", "Master Production Schedule", "Rolling MPS dengan source pegging dan planning anchor eksplisit", "/api/planning/mps", "mpsNumber", [col("mpsNumber", "No. MPS"), col("planningAnchorMonth", "Anchor", "date"), col("mpsName", "Nama MPS"), col("periodStart", "Mulai", "date"), col("periodEnd", "Selesai", "date"), col("totalPlannedQty", "Qty Plan", "number"), col("lifecycleStatus", "Lifecycle", "status"), col("replanRequired", "Replan", "boolean"), col("status", "Status", "status")]),
      ...
      page("monthly-production-plans", "Monthly Production Plan", "Rencana produksi bulanan milik PPIC", "/api/planning/monthly-production-plans", "planNumber", [col("planNumber", "Plan ID"), col("periodStart", "Mulai", "date"), col("periodEnd", "Selesai", "date"), col("targetQty", "Target", "number"), col("actualQty", "Actual", "number"), col("status", "Status", "status")]),
  ...
  },
  {
    ...
    pages: [
      ...
      { ...page("ng-dispositions", "QC Rework Judgment", "Seluruh Qty NG menunggu judgment QC: rework, reject, atau kombinasi", "/api/production/ng-dispositions", "id", [col("logDate", "Tanggal", "date"), col("logNumber", "Production Entry"), col("phaseNumber", "Phase", "number"), col("partCode", "Part Code"), col("partNumber", "Part Number"), col("processName", "Proses"), col("productionLotNumber", "Production Lot"), col("reason", "Reason NG"), col("subReason", "Sub Reason"), col("qtyNg", "Qty NG", "number"), col("qtyRework", "Rework", "number"), col("qtyReject", "Reject", "number"), col("status", "QC Status", "status")]), ngDispositionFlow: true },
      { ...page("quality-inspections", "QC Release Stock", "Periksa hasil OK dari Production Entry lalu release WIP/FG dari QC Hold", "/api/production/quality-inspections", "inspectionNumber", [col("inspectionNumber", "No. QC"), col("inspectionDate", "Tanggal", "date"), col("productionLog.logNumber", "Production Entry"), col("productionLog.operatorName", "Operator"), col("part.partCode", "Part Code"), col("part.partNumber", "Part Number"), col("batchNumber", "Batch / Lot"), col("qtyInspected", "Qty Check", "number"), col("qtyPassed", "Qty OK", "number"), col("decision", "Decision", "status"), col("status", "Release Status", "status")]), createRoute: "/modules/production/quality-inspections/new" },
